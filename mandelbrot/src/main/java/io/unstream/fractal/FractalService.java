...
public class FractalService {
    ...
    @Autowired
    Function<Fractal, ImageData> mandelbrotFunction;

    @Bean
    public Function<Fractal, byte[]> createFractal(){
        return fractal -> {

            var quad = new ImageData(fractal.getWidth(), fractal.getHeight());
    ...
    private ImageData mandelbrotQuad(Fractal fractal) {
    ...
    private byte[] createPng(ImageData imageData) {
